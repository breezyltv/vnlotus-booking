...
import { Room, RoomType, User } from "../src/lib/types";
    ...
    const users: User[] = [
      {
        ...
        contact: "kevinlethevu@gmail.com",
    ...
    const mockData: Room[] = [
      {
        ...
        image: {
          main:
            "https://media-cdn.tripadvisor.com/media/photo-o/07/18/91/93/paradise-point-resort.jpg",
        },
        description:
      ...
      },
      {
        ...
        image: {
          main:
            "https://media-cdn.tripadvisor.com/media/photo-o/0a/1b/25/38/top-of-the-hyatt-sky.jpg",
        },
        description:
      ...
      },
      {
        ...
        image: {
          main:
            "https://media-cdn.tripadvisor.com/media/photo-o/11/f1/23/66/hilton-san-diego-bayfront.jpg",
        },
        description:
      ...
      },
      {
        ...
        image: {
          main:
            "https://images.trvl-media.com/hotels/17000000/16520000/16518000/16517903/e46fb7e2.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
          collection: [
      ...
      },
      {
        ...
        image: {
          main:
            "https://images.trvl-media.com/hotels/13000000/12770000/12767200/12767198/922366c3.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        },
        description:
